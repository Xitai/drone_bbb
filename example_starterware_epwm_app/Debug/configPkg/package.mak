...
gnu.targets.arm.A8F.rootDir ?= C:/ti/gcc-arm-none-eabi-7-2018-q2-update
...
.dlls,a8fg .dlls: app.pa8fg

-include package/cfg/app_pa8fg.mak
-include package/cfg/app_pa8fg.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/app_pa8fg.dep
endif
app.pa8fg: package/cfg/app_pa8fg.xdl
	@


ifeq (,$(wildcard .libraries,a8fg))
app.pa8fg package/cfg/app_pa8fg.c: .libraries,a8fg
endif

package/cfg/app_pa8fg.c package/cfg/app_pa8fg.h package/cfg/app_pa8fg.xdl: override _PROG_NAME := app.xa8fg
package/cfg/app_pa8fg.c: package/cfg/app_pa8fg.cfg
package/cfg/app_pa8fg.xdc.inc: package/cfg/app_pa8fg.xdl
package/cfg/app_pa8fg.xdl package/cfg/app_pa8fg.c: .interfaces

clean:: clean,a8fg
	-$(RM) package/cfg/app_pa8fg.cfg
	-$(RM) package/cfg/app_pa8fg.dep
	-$(RM) package/cfg/app_pa8fg.c
	-$(RM) package/cfg/app_pa8fg.xdc.inc

clean,a8fg::
	-$(RM) app.pa8fg
.executables,a8fg .executables: app.xa8fg

app.xa8fg: |app.pa8fg

-include package/cfg/app.xa8fg.mak
app.xa8fg: package/cfg/app_pa8fg.oa8fg 
	$(RM) $@
	@$(MSG) lnka8fg $@ ...
	$(RM) $(XDCCFGDIR)$@.map
	$(gnu.targets.arm.A8F.rootDir)/bin/arm-none-eabi-gcc -mfloat-abi=hard -nostartfiles -Wl,-static -Wl,--gc-sections -g  -o $@ package/cfg/app_pa8fg.oa8fg -Wl,-T,package/cfg/app_pa8fg.xdl   -LC:/ti/bios_6_76_03_01/packages/gnu/targets/arm//libs/install-native/arm-none-eabi/lib/hard -Wl,--start-group -lgcc -lc -lm -Wl,--end-group --specs=nano.specs -Wl,-Map=$(XDCCFGDIR)/$@.map --specs=nosys.specs
	
app.xa8fg: export LD_LIBRARY_PATH=

app.test test,a8fg test: app.xa8fg.test

app.xa8fg.test:: app.xa8fg
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 app.xa8fg.test
else
	@$(MSG) running $<  ...
	$(call EXEC.app.xa8fg, ) 
endif
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
app_pa8fg.oa8fg,copy : package/cfg/app_pa8fg.oa8fg
app_pa8fg.sa8fg,copy : package/cfg/app_pa8fg.sa8fg
