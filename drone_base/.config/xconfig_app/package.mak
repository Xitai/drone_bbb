...
app.xa8fg: package/cfg/app_pa8fg.oa8fg 
	...
	@$(MSG) lnka8fg $@ ...
	$(RM) $(XDCCFGDIR)$@.map
	$(gnu.targets.arm.A8F.rootDir)/bin/arm-none-eabi-gcc -mfloat-abi=hard -nostartfiles -Wl,-static -Wl,--gc-sections    -o $@ package/cfg/app_pa8fg.oa8fg -Wl,-T,package/cfg/app_pa8fg.xdl   -LC:/ti/bios_6_76_03_01/packages/gnu/targets/arm//libs/install-native/arm-none-eabi/lib/hard -Wl,--start-group -lgcc -lc -lm -Wl,--end-group --specs=nano.specs -Wl,-Map=$(XDCCFGDIR)/$@.map --specs=nosys.specs
